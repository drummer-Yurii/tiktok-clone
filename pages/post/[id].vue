                    ...
                    <div class="flex items-center relative w-full">
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            ...
                            <div class="text-[15px] font-light">
                                ...
                                Delectus, quo velit debitis ipsum porro provident voluptatibus 
                                adipisci minus facere consequuntur alias, ea et autem explicabo 
                                nulla quos distinctio enim. Placeat!
                            </div>
                        </div>
                    </div>
                </div>
